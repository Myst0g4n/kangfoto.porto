    ...
    return (
        <section id="portfolio" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <div className="flex justify-center mt-12">
                <Link
                    href="/gallery"
                    className="group relative px-8 py-3 bg-gradient-to-r from-pink-500 to-pink-700 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-pink-500/50 transition-all duration-300 overflow-hidden"
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-pink-600 to-pink-800 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </Link>
            </div>
