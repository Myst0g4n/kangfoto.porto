...
export default function PriceList() {
        ...
        return (
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" id="pricelist">
                ...
                <div className="flex justify-center items-center h-64">
                    <p className="text-pink-200 text-xl">Loading packages...</p>
                </div>
            </section>
        );
    }
    ...
    if (error && packages.length === 0) {
        return (
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" id="pricelist">
                <h3 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-pink-400 to-pink-500 mb-12 text-center">
                    Price List
                </h3>
                <div className="flex justify-center items-center h-64">
