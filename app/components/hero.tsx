    ...
    return (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 ">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                >
                    <h1 className="text-5xl sm:text-6xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-rose-300 via-pink-300 to-amber-200 mb-6">KANG FOTO</h1>
                    <div className="mb-8 max-w-full">
                        <small className="brand-alt text-lg sm:text-xl text-rose-100 block max-w-full">
                            <Typing words={["Professional Photography Moments", "Capturing Life's Best Moments", "Creating Beautiful Memories"]} />
                        </small>
                    </div>
                    <p className="text-rose-50 mt-4 text-base sm:text-lg md:text-xl text-justify leading-relaxed">
