...
export function ProjectGalleryCardLanding({ image, onImageClick }: ProjectGalleryCardLandingProps) {
    ...
    return (
        <div
            ...
            className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-indigo-500/30 via-purple-500/30 to-pink-500/30 aspect-[3/4] cursor-pointer shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105"
        >
            {/* Thumbnail Image */}
