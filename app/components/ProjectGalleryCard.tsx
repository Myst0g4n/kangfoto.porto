...
export function ProjectGalleryCard({ image, onImageClick }: ProjectGalleryCardProps) {
    ...
    return (
        <div
            ...
            className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-pink-500/20 via-rose-500/20 to-pink-500/20 aspect-[4/3] cursor-pointer shadow-lg hover:shadow-xl transition-shadow duration-300"
        >
            {/* Thumbnail Image */}
