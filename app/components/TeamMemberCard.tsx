    ...
    return (
        ...
        >
            <div className="relative group max-w-sm w-full"> {/* Increased max-width to better fit 3 columns */}
                ...
                <div className="bg-gradient-to-br from-pink-900/30 via-rose-900/30 to-pink-900/30 backdrop-blur-lg rounded-2xl p-1 shadow-2xl shadow-pink-900/30 border border-white/10 transform transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-pink-700/40">
                    <div className="bg-gray-900/80 rounded-2xl p-6 relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 w-24 h-24 bg-rose-500/10 rounded-full -ml-12 -mb-12"></div>
                        ...
                        <div className="pt-8 relative z-10"> {/* Memberi ruang untuk foto yang keluar */}
                            ...
                            <p className="text-pink-300 text-center mt-2 font-medium text-sm">{member.experience}</p>
