    ...
    return (
        ...
        >
            <div className="relative group max-w-sm w-full"> {/* Increased max-width to better fit 3 columns */}
                ...
                <div className="bg-gradient-to-br from-pink-900/30 via-pink-800/30 to-pink-900/30 backdrop-blur-lg rounded-2xl p-1 shadow-2xl shadow-pink-900/30 border border-white/10 transform transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-pink-700/40">
